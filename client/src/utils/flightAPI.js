...
// function getFlight(start, end, date) {
//   start = "MSP";
//   end = "JFK";
//    axios({
//     "method": "GET",
//     "url": "https://skyscanner-skyscanner-flight-search-v1.p.rapidapi.com/apiservices/browsequotes/v1.0/US/USD/en-US/${start}-sky/${end}-sky/2019-09-01",
//     "headers": {
